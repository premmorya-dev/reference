...
TARGET_HESTIACP_USER="robomart-dev-03";
TARGET_HESTIACP_USER_DOMAIN="dev-03.robomart.com";
TARGET_HESTIACP_USER_DOMAIN_DATABASE_NAME="robomart_dev_03";
TARGET_HESTIACP_USER_DOMAIN_DATABASE_USER="robomart-dev-03-web";
