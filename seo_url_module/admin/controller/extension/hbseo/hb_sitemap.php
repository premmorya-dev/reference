...
class ControllerExtensionHbseoHbSitemap extends Controller {
	...
	public function index() {   
		...
		$data['sitemap_url'] = $data['sitemap_index_link'];
		$data['sitemap_seo_url'] = $data['store_url']."sitemap_index.xml";
        ...
        $base_url =  str_replace("admin/","",HTTPS_SERVER);
		$data['seo_data'] = [
	         [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/products&hbxmllang=en-gb&page=1",
				"seo_url" => $data['store_url'] . "products.xml"
			 ],

			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/product_tags&hbxmllang=en-gb&page=1",
				"seo_url" => $data['store_url'] . "product_tags.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/category&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "category.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/brand&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "brand.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/information&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "information.xml
				"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/category_to_product&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "category_to_product.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/brand_to_product&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "brand_to_product.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/journal2blog&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "journal2blog.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/journal3blog&hbxmllang=en-gb",
				"seo_url" => $data['store_url'] . "journal3blog.xml"
			 ],
			 [
				"sitemap_url" => $data['store_url'] . "index.php?route=extension/hbseo/sitemap/misc",
				"seo_url" => $data['store_url'] . "misc.xml"
			 ]
            ];

		$data['nginx_code'] = " location = /sitemap_index.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap;
			}
		
			location = /products.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/products&hbxmllang=$1&page=$1;
			}
			
			location = /products_2.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/products&hbxmllang=$2&page=$2;
			}
		
			location = /product_tags.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/product_tags&hbxmllang=$1&page=$1;
			}
		
			location = /product_tags_2.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/product_tags&hbxmllang=$1&page=$2;
			}		
		
			location = /category.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/category&hbxmllang=$1;
			}		
		
			location = /brand.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/brand&hbxmllang=$1;
			}
				
			location = /information.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/information&hbxmllang=$1;
			}
				
			location = /category_to_product.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/category_to_product&hbxmllang=$1;
			}
		
			location = /brand_to_product.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/brand_to_product&hbxmllang=$1;
			}
				
		   location = /journal2blog.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/journal2blog&hbxmllang=$1;
			}
				
			location = /journal3blog.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/journal3blog&hbxmllang=$1;
			}
		
			location = /misc.xml {
			rewrite ^(.*)$ /index.php?route=extension/hbseo/sitemap/misc;
			}
			";

			// print_r($seo_data );die;
		...
		$data['hb_sitemap_journal2'] = isset($store_info['hb_sitemap_journal2'])?$store_info['hb_sitemap_journal2']:'';
		$data['hb_sitemap_journal3'] = isset($store_info['hb_sitemap_journal3'])?$store_info['hb_sitemap_journal3']:'';
...
RewriteRule ^sitemaps/([^?]*)/journal2blog_sitemap.xml$ index.php?route=extension/hbseo/sitemap/journal2blog&hbxmllang=$1 [L,QSA]
